          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                log(driverData.toString());
                return _buildProfileCard(driverData);
              },
            ),
            ...
            _buildActionCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  _slidePageRoute(const DriverCalendarScreen()),
                );
              },
            ),
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                // Email
                Text(
                  driverData['email'] ?? 'email@example.com',
                  style: TextStyle(
                ...
                // Driver Details
                _buildInfoRow("Role", driverData['role'] ?? 'Driver'),
                SizedBox(height: 12.h),
                _buildInfoRow("Employee ID", driverData['employeeId'] ?? 'N/A'),
                SizedBox(height: 12.h),
                _buildInfoRow(
                  "License No.",
                ...
                _buildInfoRow(
                  ...
                  driverData['licenseExpiry'] != null
                      ? formatter.format(
                        (driverData['licenseExpiry'] as Timestamp).toDate(),
                      )
                      : 'N/A',
                ),
              ],
