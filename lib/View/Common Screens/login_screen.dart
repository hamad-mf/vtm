            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(
                    child: FaIcon(color: Colors.white, size: 35.w, widget.icon),
                  ),
                ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              log('Username: ${_emailController.text}');
                            ...
                            child: context.watch<LoginController>().isloading ? CircularProgressIndicator() :Text(
                              'Login',
                              style: TextStyle(
                                fontSize: 18.sp,
                                fontWeight: FontWeight.bold,
