...
class StudentCustomBottomNavbarScreen extends StatefulWidget {
  final bool isGraceActive;
  final int initialIndex;
  const StudentCustomBottomNavbarScreen({
  ...
  @override
  State<StudentCustomBottomNavbarScreen> createState() =>
      _StudentCustomBottomNavbarScreenState();
}

class _StudentCustomBottomNavbarScreenState
    extends State<StudentCustomBottomNavbarScreen>
  ...
  Widget build(BuildContext context) {
    final List<Widget> _screens = [
      StudentDashboardScreen(isGraceActive: widget.isGraceActive),
      StudentMapScreen(),
      StudentQrScreen(),
